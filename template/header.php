                ...
                <div class = "layui-col-lg12">
                    ...
                    <div class = "layui-hide-xs">
                        <ul class="layui-nav menu" lay-filter="">
                            <li class="layui-nav-item"><a href="https://www.baidu.com/" target = "_blank"><i class="layui-icon">&#xe665;</i> 百度</a></li>
                            <li class="layui-nav-item"><a href="https://www.baidu.com/" target = "_blank"><i class="layui-icon">&#xe60b;</i> 关于</a></li>
                        </ul>
                    </div>
